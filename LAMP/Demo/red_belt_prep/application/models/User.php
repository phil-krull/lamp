...
class User extends CI_Model {
  ...
  public function get_user_with_reviews($user_id)
  {
    $query = "SELECT users.name, users.alias, users.email, books.title FROM users JOIN reviews on users.id = reviews.user_id JOIN books on books.id = reviews.book_id WHERE users.id = ? ;";
    $value = array($user_id);
